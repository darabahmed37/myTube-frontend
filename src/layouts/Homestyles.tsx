...
export const HomeContainer = styled(Grid)(({theme}) => ({
	...
	[theme.breakpoints.up("lg")]: {
		maxWidth: "850px", height: "800px", maxHeight: "90vh"
...
export const Right = styled(Grid)(({theme}) => ({
	...
	position: "relative", flex: 0.5, padding: "3rem", backgroundColor: "#8EF1FF80", "&::before": {
		content: `""`,
...
export const InputForm = styled("form")(({theme}) => ({
	display: "flex", flexDirection: "column", gap: "2em", width: "80%",
}));
